...
const defaultPromo = {
  color: '0 100% 100%',
  content:
    '📚 To be a practical knowledge base for programming, 3D modelling, proceduralism, rendering and automation.\n<br><br> 🏠 An overarching focus on how these technologies connect and help visualise architectural environments form the basis of the examples.\n<br><br> 🎓 The content is designed to be a practical resource for students, educators and professionals alike.',
  design: 'default',
  links: [
    {
      emoji:
...
module.exports = {
  layout: 'base.njk',
  permalink: '/',
  documentTitle: 'ArchVizWiki',
  documentDescription:
    'Documentation for technical artists, 3D artists and developers in the field of architectural visualization.',
